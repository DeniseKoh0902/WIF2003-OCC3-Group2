...
const mealData = {
    ...
    "½ cup oatmeal with walnuts and blueberries": {
      ...
      description: "A hearty and nutritious breakfast made with ½ cup of oatmeal topped with crunchy walnuts and sweet blueberries.",
    ...
    "1 cup Greek yogurt with blueberries": {
      ...
      description: "Creamy Greek yogurt topped with sweet, juicy blueberries — a simple, healthy, and satisfying start to your day.",
    ...
    "Omelet with veggie and whole wheat toast": {
      ...
      description: "A nutritious breakfast featuring a fluffy omelet loaded with fresh veggies, paired with a slice of whole wheat toast.",
    ...
    "Protein pancake with strawberries and bananas": {
      ...
      description: "Fluffy protein pancakes topped with fresh strawberries and bananas —  a delicious and energizing breakfast.",
    ...
    "2 cup of strawberry sweet banana smoothie": {
      ...
      description: "A refreshing breakfast with two cups of smoothie made with sweet strawberries and ripe bananas.",
    ...
    "Greek yogurt bowl": {
      ...
      description: "A wholesome and satisfying bowl of creamy Greek yogurt topped with fresh fruits and crunchy nuts for a naturally nutritious and refreshing breakfast.",
    ...
    "Chicken pasta salad": {
      ...
      description: "A light and hearty lunch featuring tender chicken tossed with pasta, crisp vegetables, and a flavorful dressing for a refreshing and satisfying meal.",
    ...
    "Mediterranean chicken salad": {
      category: "lunch",
        ...
        description: "A vibrant lunch made with juicy grilled chicken, crisp greens, cucumbers, tomatoes, and olives, all tossed in a zesty Mediterranean dressing.",
      ...
      "Grilled chicken sandwich": {
        ...
        description: "A hearty and flavorful lunch with tender grilled chicken layered in a soft sandwich bun, paired with crisp lettuce and juicy tomatoes.",
      ...
      "Waldorf chicken wrap": {
        ...
        description: "A delicious wrap filled with tender chicken, crisp apples, grapes, and crunchy walnuts, all tossed in a creamy dressing for a satisfying lunch.",
      ...
      "Turkey sandwich": {
        ...
        description: "A classic and satisfying lunch with lean turkey slices layered between fresh bread, crisp lettuce, ripe tomatoes, and a touch of mustard.",
      ...
      "Teriyaki salmon bowl": {
        ...
        description: "A flavorful and satisfying lunch featuring tender teriyaki-glazed salmon served over a bed of steamed rice, paired with crisp sautéed vegetables.",
      ...
      "High protein bento lunch box": {
        ...
        description: "A simple and hearty high-protein bento lunch box with grilled chicken, fresh veggies, and steamed rice, providing a balanced and energizing meal.",
      ...
      "Salmon salad wrap": {
        ...
        description: "A light and tasty lunch featuring fresh salmon, crisp veggies, and a tangy dressing, all wrapped in a soft tortilla for a healthy and satisfying meal.",
    ...
    "Beef enchiladas": {
      ...
      description: "A flavorful dinner featuring tender beef wrapped in soft tortillas, smothered in rich enchilada sauce, and baked to perfection with melted cheese.",
    ...
    "Hummus and veggies": {
      ...
      description: "A light and healthy dinner featuring creamy hummus paired with a variety of fresh, crunchy vegetables for a refreshing and satisfying meal.",
    ...
    "2 shrimp tacos": {
      ...
      description: "A delicious dinner with two soft tacos filled with tender shrimp, crisp veggies, and a zesty sauce, offering a light yet flavorful meal.",
      calories: "301 calories",
      ingredients: [
    ...
    "Turkey sweet potato chili": {
      ...
      description: "A comforting dinner featuring lean turkey and tender sweet potatoes simmered in a flavorful chili, creating a hearty and nutritious meal.",
    ...
    "Burrito bowl": {
      ...
      description: "A satisfying dinner featuring a hearty mix of rice, seasoned meat, beans, veggies, and your choice of toppings, all perfectly combined for a flavorful meal.",
      calories: "591 calories",
      ingredients: [
        "1/2 cup cooked rice",
...
function initModal() {
  ...
  // Attach click events to all meal links (including dynamically loaded ones)
  ...
  document.querySelectorAll('.fa-heart').forEach(icon => {
    icon.addEventListener('click', function (e) {
      ...
      if (isFav) {
        ...
        // Optional: If on favouritemeals.html, reload the list after removing
...
function loadFavoriteMeals() {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    if (key.startsWith('fav_')) {
      const mealId = key.slice(4); // remove 'fav_'
      if (mealData[mealId]) {
  ...
  if (favorites.length === 0) {
    container.innerHTML = '<p class="no-favorites">You haven\'t added any favorite meals yet.</p>';
    return;
  }
...
favorites.forEach(mealId => {
  ...
  // Extract number from calorie string (e.g., "233 calories" -> 233)
...
window.addEventListener('scroll', function() {
  ...
  // You could add logic here to hide/show specific buttons based on position
  // For example, hide "scroll to top" when at top, etc.
});
